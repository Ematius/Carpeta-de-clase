...
//* Explicación General:
//* Este archivo define una función `openConnection` que abre una conexión a la base de datos MySQL 
//* utilizando las propiedades definidas en las variables de entorno. La función imprime información 
//* sobre la conexión en la consola y devuelve la conexión creada.
